...
namespace ILA_Server.Migrations
{
    ...
    [Migration("20190701212637_ProfQuestions")]
    partial class ProfQuestions
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ILA_Server.Models.CourseNews", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("ILA_Server.Models.ProfAnswer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<int>("ProfQuestionId");

                    b.HasKey("Id");

                    b.HasIndex("ProfQuestionId");

                    b.ToTable("ProfAnswer");
                });

            modelBuilder.Entity("ILA_Server.Models.ProfQuestion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("ProfQuestion");
                });

            modelBuilder.Entity("ILA_Server.Models.ProfQuestionAnswer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.HasIndex("ProfAnswerId");

                    b.HasIndex("UserId");

                    b.ToTable("ProfQuestionAnswer");
                });

            modelBuilder.Entity("ILA_Server.Models.PushTokens", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("ILA_Server.Models.ProfAnswer", b =>
                {
                    b.HasOne("ILA_Server.Models.ProfQuestion", "ProfQuestion")
                        .WithMany("Answers")
                        .HasForeignKey("ProfQuestionId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("ILA_Server.Models.ProfQuestionAnswer", b =>
                {
                    b.HasOne("ILA_Server.Models.ProfAnswer", "ProfAnswer")
                        .WithMany("ProfQuestionAnswers")
                        .HasForeignKey("ProfAnswerId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("ILA_Server.Models.ILAUser", "User")
                        .WithMany("ProfAnswers")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
